...
const Filters: FC = () => {
  ...
  return (
    <div className="border-[1px] border-l-0 w-full h-full flex flex-col justify-start items-start">
      <span className="uppercase w-full pl-[30%] text-start py-2 border-b-[1px] select-none">
        SORT BY
      </span>
      <div className="flex flex-col border-b-[1px] w-full py-4">
      ...
      <FilterButton
        ...
        styles="border-b-[1px] w-full pl-[30%]"
