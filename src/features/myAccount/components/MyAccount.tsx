...
const MyAccount: FC = () => {
  ...
  return (
    <div className="flex w-full h-full space-x-3 ">
      <div className="border-t-[1px] border-r-[1px] w-1/5 flex flex-col rounded-tr-md">
      ...
      <div className="border-[1px] border-b-0 rounded-tl-md rounded-tr-md w-4/5 overflow-x-scroll scrollbar-hide">
